Module.register('page-indicator', {
  ...
  notificationReceived(notification, payload) {
    ...
    if (notification === 'PAGE_CHANGED') {
      ...
      this.mmmPagesDetected = MM.getModules().withClass("pages").length > 0;
      Log.log(`[${this.name}]: pages detected. Will ignore PAGE_INCREMENT and PAGE_DECREMENT as it is already handled by MMM-pages`);
    }
  },
