...
void TIM1_CC_IRQHandler(void)
{
	...
	if(sr04_1.distance <= sr04_2.distance)
		if(sr04_1.distance <= sr04_3.distance)
			motor.distance = sr04_1.distance;
		else
			motor.distance = sr04_3.distance;
	else
		if(sr04_2.distance <= sr04_3.distance)
			motor.distance = sr04_2.distance;
		else
			motor.distance = sr04_3.distance;
